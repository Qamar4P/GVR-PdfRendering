...
public class Main extends GVRMain {
    ...
    private GVRViewSceneObject mPdfSceneObject;
...
//        cube.close();
        ...
        //my-<code></code>
        mPdfSceneObject = new GVRViewSceneObject(gvrContext,
                mActivity.getPdfView(), 4.0f, 4.0f);
        gvrContext.getMainScene().addSceneObject(mPdfSceneObject);
        mPdfSceneObject.getTransform().setPosition(0.0f, 0.0f, -2.5f);
    }
